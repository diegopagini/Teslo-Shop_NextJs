...
const ProductAdminPage: FC<Props> = ({ product }) => {
	...
	const fileInputRef = useRef<HTMLInputElement>(null); // Como el ViewChild de Angular...
	...
	const onFilesSelected = async ({ target }: ChangeEvent<HTMLInputElement> | any) => {
					...
					<Grid item xs={12} sm={6}>
						...
						<Box display='flex' flexDirection='column'>
							...
							<Button
								...
								// fileInputRef es la referencia para poder llamarlo
							>
								Cargar imagen
							</Button>
							<input
								ref={fileInputRef} // para darle referencia y poder llamarlo
								type='file'
								multiple
